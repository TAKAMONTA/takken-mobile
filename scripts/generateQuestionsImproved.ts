...
[
  {
    "question": "問題文（60文字以上、具体的な事例を含む）",
    "choices": ["選択肢1", "選択肢2", "選択肢3", "選択肢4"],
    "correctAnswer": 0,
        "explanation": "解説文（80文字以上、以下を必ず含める）\n\n【各選択肢の解説】\n1. 選択肢1の正誤理由\n2. 選択肢2の正誤理由\n3. 選択肢3の正誤理由\n4. 選択肢4の正誤理由\n\n【関連法令】該当する法令名と条文番号\n\n【実務上の注意点】実務での重要ポイント",ポイント",
    "topic": "テーマ名"
  }
]

【重要な要件】
1. 問題文は最低60文字以上、具体的な事例を含める
2. 選択肢は紛らわしく、思考力を問うものにする
3. 解説は最低80文字以上、以下を必ず含める：
   - 各選択肢の正誤理由（4つすべて）
   - 関連する法令名と条文番号
   - 実務での注意点や補足情報
...
async function main() {
  ...
  console.log('   2. 問題文の最低文字数: 60文字（緩和版）');
  console.log('   3. 解説の最低文字数: 80文字（緩和版）');
